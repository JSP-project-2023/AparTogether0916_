...
public class PagingVote {
	...
	private String mode = "" ; // 검색 모드(예시 : 제목, 작성자, 마감여부)
	private String keywordEndVote = "" ; // 마감여부 검색 모드(예시 : 마감, 진행중)
	private String keyword = "" ; // 검색할 단어	
	
	private String flowParameter = "" ; // 페이지 이동시 같이 수반되는 파라미터 리스트
	
	public PagingVote(String _pageNumber, String _pageSize, int totalCount, String url, String mode, String keywordEndVote, String keyword, boolean isGrid) {
		...
		this.keywordEndVote = keywordEndVote==null ? "all" : keywordEndVote ;
		...
		this.flowParameter += "&keywordEndVote=" + keywordEndVote ;
	...
	private String makeLiTag(String caption, int currPageNumber) {
		...
		result += "&keywordEndVote=" + this.keywordEndVote;
	...
	public String getKeywordEndVote() {
		return keywordEndVote;
	}

	public void setKeywordEndVote(String keywordEndVote) {
		this.keywordEndVote = keywordEndVote;
	}
