            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
               <ul class="navbar-nav">   
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<%=notWithFormTag%>prList">이벤트(href : null)</a></li>
                        <c:if test="${whologin eq 1}">
                           <li><a class="dropdown-item" href="<%=notWithFormTag%>prInsert">이벤트 등록(href : null)</a></li>
                        </c:if>
                     </ul>
                  </li>      
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu">
                        <li>
                           <a class="dropdown-item" href="<%=notWithFormTag%>vwList">투표(href : null)</a>                           
                        </li>
                        <c:if test="${whologin eq 1}">
                           <li><a class="dropdown-item" href="<%=notWithFormTag%>prInsert">투표 등록(href : null)</a></li>
                        </c:if>
                     </ul>
                  </li>
