...
>>>>>>> origin/sup_merge_all_01
				...
				<ul class="navibar">
					...
					<c:if test="${whologin eq 0 }">
						<li class="member-nav-li">
							<a class="member_menu" href="<%=notWithFormTag%>meLogin">로그인</a>
						</li>
						<li class="member-nav-li">
							<a class="member_menu" href="<%=notWithFormTag%>meInsert">회원 가입</a>
						</li>
					</c:if>
					...
					<c:if test="${whologin eq 1 }">
						<li class="member-nav-li">
							...
							<ul class="subnavbar">
								<li class=""><a class="min_submenu" href="<%=notWithFormTag%>meList">회원 목록</a></li>
								<li class=""><a class="min_submenu" href="<%=notWithFormTag%>meLogout">로그아웃</a></li>
							</ul>
						</li>
					</c:if>
					...
					<c:if test="${whologin eq 2 }">
						<li class="member-nav-li">
							...
							<ul class="subnavbar">
								<li class=""><a class="min_submenu" href="<%=notWithFormTag%>meDetail&id=${sessionScope.loginfo.id}">마이페이지</a></li>
								<li class=""><a class="min_submenu" href="<%=notWithFormTag%>meLogout">로그아웃</a></li>
							</ul>
						</li>
					</c:if>
				...
				<a href="#" class="navibar_toggleBtn"><i class="fa fa-bars" aria-hidden="true"></i></a> <!-- aria-hidden="true" -->
			</nav>
