...
<c:if test="${not empty sessionScope.loginfo}">
	<c:if test="${sessionScope.loginfo.metype == 'admin'}">
		<c:set var="whologin" value="2"/>
	</c:if>
	<c:if test="${sessionScope.loginfo.metype != 'admin'}">
...
<head>
	...
	<style type="text/css">
		...
		.navbar{ font-family: "Black Han Sans";}
		.bigsize{ font-size: 80px; margin-right: 150px; text-decoration: none; color: black; margin-top: 10px}
		.navbar-brand{margin-right: 150px;}
		.nav-item{font-size: 45px; margin-top: 15px; margin-right: 30px;  font-family: 'Nanum Gothic'; font-weight: bold;}
		#margin{margin : 50px; margin-left : 150px; margin-right: 150px;}
		.body{align-content: center}
		.navbar-logo{margin-right: 25px; font-size: 15px}
		.dropdown-item{font-size : 20px; font-family: 'Nanum Gothic'; text-align: left;}
		#small{margin-top: -16px;}
		#behind{display: none;}
		.small-tip{ font-size:25px; text-decoration: none; color: grey; font-family: 'Nanum Gothic';}
		.tips{margin-top: 75px; margin-left: 70px;}
	</style>
</head>
	...
	<header id = "margin">
		<nav class="navbar navbar-expand-sm  ">
			<div class="container-fluid">
				...
				<a class="bigsize" href="#">APTogether</a>
					...
					<ul class="navbar-nav">	
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item" href="<%=notWithFormTag%>meInsert">가게목록</a></li>								
									
									<c:if test="${whologin eq 2 }">
										<li><a class="dropdown-item" href="<%=notWithFormTag%>meLogin">내 가게 보기</a></li>
										<li><a class="dropdown-item" href="<%=notWithFormTag%>meLogin">접수 현황</a></li>
									</c:if>
							</ul>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								<c:if test="${whologin ne 2}">
									<li><a class="dropdown-item" href="<%=notWithFormTag%>boInsert"> 주문내역</a></li>
								</c:if>
								<li><a class="dropdown-item" href="<%=notWithFormTag%>boList">모집 중인 주문</a></li>
							</ul>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								<c:if test="${whologin eq 1}">
									<li><a class="dropdown-item" href="<%=notWithFormTag%>prInsert">이벤트 등록</a></li>
								</c:if>
								<li><a class="dropdown-item" href="<%=notWithFormTag%>prList">이벤트</a></li>
							</ul>
						</li>		
